...
1. Expanded the folder named A1-AccountGenerator and create a new file named AccountGenerator.java
...
### Problem Description
Write an application that creats an prints a random phone number of the form XXX-XXX-XXXX. Include the dashes in the output.  Do not let the first three digits contain an 8 or 9 (but don't be more restrictive than that), and make sure that the second set of three digits is not greater than 742.  

*Hint: Think through the easiest way to construct the phone number. Each digit does not have to be determined separately.*
### Implementation Guide
1. Expanded the folder named A2-PhoneNumbers and create a new file named PhoneNumbers.java
...
### Impementation Guide
1. Expanded the folder named A3-DistanceCalculator and create a new file named DistanceCalculator.java
...
### Problem Description
Write an application that reads the radius of a shpere and prints its volume and surface area.  Use the following formulas, in which r represents the sphere's radius.  Print the output to four decimal places.

<img src="images/volume-and-surface-area-formula.png" alt="Heron's Formula" width="350">

### Impementation Guide
1. Expanded the folder named A4-SphereCalculator and create a new file named SphereCalculator.java
...
### Impementation Guide
1. Expanded the folder named A5-TriangleCalculator and create a new file named TriangleCalculator.java
